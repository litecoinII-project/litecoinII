# Support for Output Descriptors in LitecoinII Core

Since LitecoinII Core v0.17, there is support for Output Descriptors. This is a
...
existing LitecoinII Core wallets, a convenience function `combo` is
