...
- Segwit addresses (bech32, of the form `lc21...` for mainnet or `tlc21...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
