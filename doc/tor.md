...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServicePort 9223 127.0.0.1:9223
	HiddenServicePort 19223 127.0.0.1:19223

The directory can be different of course, but virtual port numbers should be equal to
your litecoind's P2P listen port (9223 by default), and target addresses and ports
...
and open port 9223 on your firewall (or use -upnp).
