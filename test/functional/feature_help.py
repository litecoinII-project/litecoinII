...
"""Verify that starting litecoinII with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litecoinII with -h for help text")
        ...
        self.log.info("Start litecoinII with -version for version information")
        ...
        self.log.info("Start litecoinIId with -fakearg to make sure it does not start")
