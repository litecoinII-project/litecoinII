...
bech32_templates = [
  ...
  ('lc2',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('lc2',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('lc2',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('lc2',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tlc2',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlc2',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlc2',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlc2',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tlc2',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tlc2',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tlc2',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tlc2',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rlc2',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rlc2',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rlc2',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rlc2', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tlc2',   17, 32, Encoding.BECH32M, False, False, False),
  ('rlc2',  3,  1, Encoding.BECH32M, False, False, False),
  ('lc2',   15, 41, Encoding.BECH32M, False, False, False),
  ('tlc2',    0, 16, Encoding.BECH32,  False, False, False),
  ('rlc2',  0, 32, Encoding.BECH32,  True,  False, False),
  ('lc2',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tlc2',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rlc2',  0, 20, Encoding.BECH32,  False, False, True),
  ('lc2',    0, 20, Encoding.BECH32M, False, False, False),
  ('tlc2',    0, 32, Encoding.BECH32M, False, False, False),
  ('rlc2',  0, 20, Encoding.BECH32M, False, False, False),
  ('lc2',    1, 32, Encoding.BECH32,  False, False, False),
  ('tlc2',    2, 16, Encoding.BECH32,  False, False, False),
  ('rlc2', 16, 20, Encoding.BECH32,  False, False, False),
]
