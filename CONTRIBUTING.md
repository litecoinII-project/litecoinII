Contributing to LitecoinII Core
============================

The LitecoinII Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the LitecoinII Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/litecoinII-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to litecoinII-qt
...
The following applies to code changes to the LitecoinII Core project (and related
projects such as libsecp256k1), and is not to be confused with overall LitecoinII
Network Protocol consensus changes.

Whether a pull request is merged into LitecoinII Core rests with the project merge
...
Patches that change LitecoinII consensus rules are considerably more involved than
...
Where a patch set proposes to change the LitecoinII consensus, it must have been
...
The project leader is the release manager for each LitecoinII Core release.
