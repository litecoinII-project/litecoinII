...
{
    const char* pszTimestamp = "LitecoinII 2026 — A Second Chance for the Litecoin Generation";
    const CScript genesisOutputScript = CScript() << ParseHex("045647107a5ca1b94704dda47ac250914be23002fff327828a09a1d6049ca4c9d7dddaa151c7bc9747c0ea0c953fcf51a1b23f9f824c3e5646e89db8130d5c3e28") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0xfefb8200c7da35576d1d54ede22de1e69f5d8a5ee598b7535548d9632b367e3b");
        ...
        consensus.NewDiffForkHeight = 62573;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeoutHeight = 209664;
        ...
        genesis = CreateGenesisBlock(1773259668, 99896, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfefb8200c7da35576d1d54ede22de1e69f5d8a5ee598b7535548d9632b367e3b"));
        assert(genesis.hashMerkleRoot == uint256S("0xbb7a5243d5c94af0f9c6f6b1f4d633396552c6e1f23629853c7abd62c54e411c"));
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("81e63b43e7ebeb2b13dd4c009335b0344c9cade2bc2f61ac30bb4ee5c91e195f");
        consensus.BIP65Height = 0;
        consensus.BIP66Height = 0;
        consensus.CSVHeight = 0;
        consensus.SegwitHeight = 0;
        ...
        consensus.fPowNoRetargeting = false;
        consensus.NewDiffForkHeight = 150;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartHeight = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeoutHeight = 209664; // 364 days later
        ...
        genesis = CreateGenesisBlock(1773102955, 1157667, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x81e63b43e7ebeb2b13dd4c009335b0344c9cade2bc2f61ac30bb4ee5c91e195f"));
        assert(genesis.hashMerkleRoot == uint256S("0xbb7a5243d5c94af0f9c6f6b1f4d633396552c6e1f23629853c7abd62c54e411c"));

        //vFixedSeeds.clear();
        //vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seeds.lc2.online");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1773102584, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6f5ba2dadf1968f5b1268868a05c6caa547875f0a91900285624d7c63deb4bd4"));
        assert(genesis.hashMerkleRoot == uint256S("0xbb7a5243d5c94af0f9c6f6b1f4d633396552c6e1f23629853c7abd62c54e411c"));
        ...
        checkpointData = {
            {
                {0, uint256S("6f5ba2dadf1968f5b1268868a05c6caa547875f0a91900285624d7c63deb4bd4")},
            }
        };
