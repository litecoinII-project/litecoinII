...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litecoinII-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  litecoinII-tx [options] <hex-tx> [commands]  Update hex-encoded litecoinII transaction\n" +
            "or:     litecoinII-tx [options] -create [commands]   Create hex-encoded litecoinII transaction\n" +
            "\n";
